...
import com.frame.core.autoscreen.util.Dp2pxUtils;
import com.frame.core.autoscreen.util.ViewUtils;

/**
 * Created by yzd on 2018/5/9 0009.
 */

public class AutoScreenHelper extends AbsScreenHelper {
    public AutoScreenHelper(Context context, int designWidth, int designDpi, float fontSize, String unit) {
