package com.frame.core.widget.guideview;
 ...
 * {@link com.frame.core.widget.guideview.Component},设置文字或者图片等
 * {@link com.frame.core.widget.guideview.Component#getView(android.view.LayoutInflater)}
 * . 所有的图片文字都是相对于targetRect来定义的。可以设定额外的x，
 * {@link com.frame.core.widget.guideview.Component#getXOffset()} ;y偏移量,
 * {@link com.frame.core.widget.guideview.Component#getYOffset()}。
 * </p>
 * <p>
