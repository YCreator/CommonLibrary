 ...
 * @author Vondear
 */
class RxPopupBackgroundConstructor {

    /**
     * Select which background will be assign to the tip view
     */
    static void setBackground(View tipView, RxPopup rxPopupView) {
    ...
    private static void setToolTipAboveBackground(View tipView, RxPopup rxPopupView) {
    ...
    private static void setToolTipBelowBackground(View tipView, RxPopup rxPopupView) {
