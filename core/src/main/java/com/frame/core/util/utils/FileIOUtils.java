 ...
 *     time  : 2017/06/22
 *     desc  : utils about file io(文件工具)
 *     menu
 *          writeFileFromIS            : 1.将输入流写入文件
            writeFileFromBytesByStream : 2.将字节数组写入文件
            writeFileFromBytesByChannel: 3.将字节数组写入文件
            writeFileFromBytesByMap    : 4.将字节数组写入文件
            writeFileFromString        : 5.将字符串写入文件
            readFile2List              : 6.读取文件到字符串链表中
            readFile2String            : 7.读取文件到字符串中
            readFile2BytesByStream     : 8.读取文件到字节数组中
            readFile2BytesByChannel    : 9.读取文件到字节数组中
            readFile2BytesByMap        : 10.读取文件到字节数组中
            setBufferSize              : 11.设置缓冲区尺寸
 * </pre>
 */
