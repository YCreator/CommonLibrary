...
//    private HashMap<String, String> map;//管理权限的map
    ...
    public void request(OnSuccessListener listener, String... permissions) {


        RxPermissions rxPermissions = new RxPermissions(mActivity);
        Observable.just(new Object()).compose(rxPermissions.ensureEach(permissions)).subscribe(permission -> {
            //这里记录一下 所有
    ...
    public void initDialog(List<Permission> data) {
        ...
        builder.setCancelable(false).setPositiveButton("确定", (dialog, which) -> {
