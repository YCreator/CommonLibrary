...
public final class ItemBinding<T> {
    ...
    /**
     * Set the variable id and layout. This is normally called in .
     */
    ...
    /**
     * Clear all extra variables. This is normally called in .
     */
    ...
    /**
     * Remove an extra variable with the given variable id. This is normally called in .
     */
